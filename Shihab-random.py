# Decompile by Mardis (Tools By Shihab King)
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\033[1;37m         ##  # # ### # # # # ##      ### ### ### # #  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            SHIHAB KING 
\033[1;37m Facebook:            SHIHAB RANA
\033[1;37m Github  :            SHIHAB99S
\033[1;37m Version :            2.1
\033[1;37m------------------------------------------------ """
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[SHIHAB] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [SHIHAB-CP] %s | %s\033[0;97m         "%(uid, pw))
